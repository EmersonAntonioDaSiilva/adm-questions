...
@RequestScoped
@FacesConverter(LocalDateYearConverter.CONVERTER_ID)
public class LocalDateYearConverter implements Converter {

	public static final String CONVERTER_ID = "LocalDateYearConverter";
	...
	public String getAsString(FacesContext context, UIComponent component, Object value) {
		...
		return DateUtils.format(date, "yyyy");
	}
