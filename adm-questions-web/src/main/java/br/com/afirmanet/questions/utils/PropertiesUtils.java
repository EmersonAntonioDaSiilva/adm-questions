...
public final class PropertiesUtils {
	 ...
	 * @return Valor referente à chave passada por parâmetro ou o valor default.
	 */
	public static Double getValueAsDouble(final Properties properties, final String key) {
	 ...
	 * @return Valor referente à chave passada por parâmetro ou o valor default.
	 */
	public static Double getValueAsDouble(final Properties properties, final String key, final String defaultValue) {
